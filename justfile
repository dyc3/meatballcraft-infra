...
test: e2e e2e-package-install e2e-service-discovery e2e-nuclearcraft-discovery e2e-reactor-network e2e-heat-network e2e-turbine-network e2e-reactor-relay e2e-provision-drive
